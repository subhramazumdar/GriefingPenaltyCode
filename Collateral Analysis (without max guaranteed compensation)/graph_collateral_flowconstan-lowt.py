...
def launch_attack_channel(G,gamma,per_tx_val,path_length,adv_budget,fraction,max_limit,cc1):
...
def main():
   ...
   # set_graph_color(G)
    ...
    budget,count=launch_attack_channel(G_tmp,gamma,per_tx_val,path_length,adv_budget,1,2016,count1)
    #f1.write(sys.argv[1]+" "+str(per_tx_val)+" "+str(adv_budget)+" "+str(budget)+" "+str(budget1)+" "+str(count)+" "+str(count1)+"\n")
    f1.write(sys.argv[1]+" "+str(path_length)+" "+str(adv_budget)+" "+str(gamma)+" "+str(per_tx_val)+" "+str(budget)+" "+str(count)+" "+str(budget1)+" "+str(count1)+"\n")
    G_tmp=G.copy()
