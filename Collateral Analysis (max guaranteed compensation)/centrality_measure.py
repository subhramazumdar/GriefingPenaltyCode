...
def read_graph(source,chan_ratio=2):
    ...
    for edge in G.edges:
        ...
        G.edges[edge]['deposit2']=int(G.edges[edge]['capacity'])/2
        G.edges[edge]['capacity']=int(G.edges[edge]['capacity'])-int(G.edges[edge]['deposit2'])
