...
def plot_graph (G):
    ...
    node_hover_tool = HoverTool(tooltips=[("pubkey", "@index"),("alias", "@alias"),("degree","@degree"),("betweenness_centrality","@betweenness_centrality")])
...
def set_graph_color (G,list_node):
